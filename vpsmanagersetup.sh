...
echo ""
echo "Ao utilizar o 'VPS Manager 2.5' você concorda com os seguintes termos de uso:"
echo ""
echo "1. Você pode:"
...
if [ -f "/usr/sbin/ufw" ] ; then
	ufw allow 443/tcp ; ufw allow 80/tcp ; ufw allow 3128/tcp ; ufw allow 8799/tcp ; ufw allow 8080/tcp 1> /dev/null 2> /dev/stdout
fi
if [ -d "/etc/squid3/" ]
then
...
if [ -d "/etc/squid/" ]
then
	wget http://keeptunnel.com.br/vpsmanager/squid1.txt -O /tmp/sqd1
	echo "acl url3 dstdomain -i $ipdovps" > /tmp/sqd2
	wget http://keeptunnel.com.br/vpsmanager/squid.txt -O /tmp/sqd3
	cat /tmp/sqd1 /tmp/sqd2 /tmp/sqd3 > /etc/squid/squid.conf
	tput setaf 6 ; tput bold ; echo "Configurando Hosts das payloads..." ; tput sgr0
	wget http://keeptunnel.com.br/vpsmanager/payload.txt -O /etc/squid3/payload.txt > /dev/null
